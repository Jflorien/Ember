...
/**
 * The DM console's damage/heal/condition composers, plus the picker that
 * decides who they target. Target selection is in-page state (a session
 * of "who am I acting on right now" changes far more often than the page
 * itself), unlike the campaign switcher, which is real navigation.
 */
